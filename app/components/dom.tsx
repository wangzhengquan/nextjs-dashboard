...
export default function DomUtil({}) {
    return(
    <>
    <ArrayUtil/>
    <StringUtil/>
    ...
    Dom7.prototype = {
        ...
        parent: function (selector) {
            ...
            for (var i = 0; i < this.length; i++) {
                if (this[i].parentNode !== null) {
                    if (selector) {
                        if (dquery(this[i].parentNode).is(selector)) parents.push(this[i].parentNode);
                    }
                    else {
            ...
            return dquery(ArrayUtil.unique(parents));
        },
        parents: function (selector) {
            ...
            for (var i = 0; i < this.length; i++) {
                ...
                while (parent) {
                    if (selector) {
                        if (dquery(parent).is(selector)) parents.push(parent);
                    }
                    else {
                        parents.push(parent);
                    }
            ...
            for (var i = 0; i < this.length; i++) {
                ...
                for (var j = 0; j < childNodes.length; j++) {
                    if (!selector) {
                        ...
                        if (childNodes[j].nodeType === 1 && dquery(childNodes[j]).is(selector)) children.push(childNodes[j]);
                    }
                }
            }
